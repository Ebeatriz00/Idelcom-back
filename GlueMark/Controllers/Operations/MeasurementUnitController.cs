...
namespace Idelcom.Controllers.Operations
{
    ...
    [ApiController]
    public class MeasurementUnitController(GetSelectMeasurementUnit getSelectUseCase) : BaseController
    {
        private readonly GetSelectMeasurementUnit _getSelectUseCase = getSelectUseCase;
