...
{
    public class GetSelectConceptType
    {
        private readonly IConceptTypeRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectConceptType(IConceptTypeRepository repository, IMapper mapper)
        {
        ...
        {
            var entities = await _repository.GetConceptTypesForSelectAsync(businessId, search, page, pageSize);
