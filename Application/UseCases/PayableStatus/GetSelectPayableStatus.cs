...
namespace Application.UseCases.PayableStatus
{
    public class GetSelectPayableStatus
    {
        private readonly IPayableStatusRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectPayableStatus(IPayableStatusRepository repository, IMapper mapper)
        {
