...
{
    public class CreateSalesQuotationVer
    {
        ...
        public CreateSalesQuotationVer(ISalesQuotationRepository repository, IValidator<SalesQuotationCreateDto> validator, IMapper mapper)
        {
        ...
        public async Task<GlobalResponse> ExecuteAsync(SalesQuotationCreateDto dto)
        {
            ...
            var response = await _repository.AddVerAsync(entity);
