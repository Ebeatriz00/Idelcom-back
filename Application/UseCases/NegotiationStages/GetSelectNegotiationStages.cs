...
namespace Application.UseCases.NegotiationStages
{
    public class GetSelectNegotiationStages
    {
        private readonly INegotiationStagesRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectNegotiationStages(INegotiationStagesRepository repository, IMapper mapper)
        {
