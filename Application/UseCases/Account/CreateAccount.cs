...
namespace Application.UseCases.Account
{
    public class CreateAccount
    {
        ...
        public CreateAccount(IAccountRepository repository, IValidator<AccountCreateDto> validator, IMapper mapper)
        {
        ...
        public async Task<GlobalResponse> ExecuteAsync(AccountCreateDto dto)
        {
