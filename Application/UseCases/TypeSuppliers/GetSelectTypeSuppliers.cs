...
namespace Application.UseCases.TypeSuppliers
{
    public class GetSelectTypeSuppliers
    {
        private readonly ITypeSuppliersRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectTypeSuppliers(ITypeSuppliersRepository repository, IMapper mapper)
        {
