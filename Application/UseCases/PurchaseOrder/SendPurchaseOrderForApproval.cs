...
{
    public class SendPurchaseOrderForApproval(
        IPurchaseOrderRepository repository,
        IValidator<PurchaseOrderSendForApprovalDto> validator,
        ...
        IMapper mapper)
    {
        ...
        private readonly IValidator<PurchaseOrderSendForApprovalDto> _validator = validator;
        private readonly ISqlConnectionFactory _sqlConnectionFactory = sqlConnectionFactory;
        private readonly IAuditService _auditService = auditService;
        private readonly IAuditLogFactory _auditLogFactory = auditLogFactory;
        private readonly IMapper _mapper = mapper;

        public async Task<BaseResponse> ExecuteAsync(PurchaseOrderSendForApprovalDto dto, long userId, long businessId)
        {
            ...
            try
            {
                ...
                var result = await _repository.SendForApprovalAsync(businessId, dto.PurchaseOrderId, userId, transaction);
