...
namespace Application.UseCases.Area
{
    public class CreateArea
    {
        ...
        private readonly IValidator<AreaCreateDto> _validator;
        private readonly IMapper _mapper;

        public CreateArea(IAreaRepository repository, IValidator<AreaCreateDto> validator, IMapper mapper)
        {
        ...
        public async Task<GlobalResponse> ExecuteAsync(AreaCreateDto dto)
        {
