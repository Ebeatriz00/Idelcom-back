...
namespace Application.UseCases.PurchaseOrderStatus
{
    public class GetSelectPurchaseOrderStatus
    {
        private readonly IPurchaseOrderStatusRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectPurchaseOrderStatus(IPurchaseOrderStatusRepository repository, IMapper mapper)
        {
