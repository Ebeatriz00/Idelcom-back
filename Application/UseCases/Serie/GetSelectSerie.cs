...
namespace Application.UseCases.Series
{
    ...
    public class GetSelectSeries
    {
        private readonly ISeriesRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectSeries(ISeriesRepository repository, IMapper mapper)
        {
        ...
        {
            var entities = await _repository.GetSeriesForSelectAsync(businessId, search, page, pageSize);
