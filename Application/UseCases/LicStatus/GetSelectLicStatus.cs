...
namespace Application.UseCases.LicStatus
{
    public class GetSelectLicStatus
    {
        private readonly ILicStatusRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectLicStatus(ILicStatusRepository repository, IMapper mapper)
        {
