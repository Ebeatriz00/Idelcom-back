...
{
    public class GetSelectCurrency
    {
        private readonly ICurrencyRepository _repository;
        private readonly IMapper _mapper;

        public GetSelectCurrency(ICurrencyRepository repository, IMapper mapper)
        {
        ...
        {
            var entities = await _repository.GetCurrencyForSelectAsync(businessId, search, page, pageSize);
