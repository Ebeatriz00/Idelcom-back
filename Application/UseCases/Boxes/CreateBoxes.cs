...
namespace Application.UseCases.Boxes
{
    public class CreateBoxes
    {
        ...
        private readonly IValidator<BoxesCreateDto> _validator;
        private readonly IMapper _mapper;

        public CreateBoxes(IBoxesRepository repository, IValidator<BoxesCreateDto> validator, IMapper mapper)
        {
        ...
        public async Task<GlobalResponse> ExecuteAsync(BoxesCreateDto dto)
        {
