...
{
    public class GetSelectProfiles
    {
        private readonly IProfilesRepository _repository;
        private readonly IMapper _mapper;
        public GetSelectProfiles(IProfilesRepository repository, IMapper mapper)
        {
        ...
        {
            var entities = await _repository.GetProfilesForSelectAsync(businessId, search, page, pageSize);
