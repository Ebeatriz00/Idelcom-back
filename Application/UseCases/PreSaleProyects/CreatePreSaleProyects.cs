...
{
    public class CreatePreSaleProyects
    {
        private readonly IPreSaleProyectsRepository _repository;
        private readonly IValidator<PreSaleProyectsCreateDto> _validator;
        private readonly IMapper _mapper;

        public CreatePreSaleProyects(
            IPreSaleProyectsRepository repository,
            IValidator<PreSaleProyectsCreateDto> validator,
            IMapper mapper)
        {
        ...
        public async Task<GlobalResponse> ExecuteAsync(PreSaleProyectsCreateDto dto)
        {
