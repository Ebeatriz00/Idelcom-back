...
{
    public class GetSelectWorker
        {
            private readonly IWorkerRepository _repository;
            private readonly IMapper _mapper;

            public GetSelectWorker(IWorkerRepository repository, IMapper mapper)
            {
            ...
            {
                var entities = await _repository.GetWorkerForSelectAsync(businessId, search, page, pageSize);
