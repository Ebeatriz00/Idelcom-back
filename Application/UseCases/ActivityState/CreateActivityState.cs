...
{
    public class CreateActivityState
    {
        private readonly IActivityStateRepository _repository;
        private readonly IValidator<ActivityStateCreateDto> _validator;
        private readonly IMapper _mapper;

        public CreateActivityState(IActivityStateRepository repository, IValidator<ActivityStateCreateDto> validator, IMapper mapper)
        {
        ...
        public async Task<GlobalResponse> ExecuteAsync(ActivityStateCreateDto dto)
        {
            ...
            {
                Status = 1,
                Message = "Estado de atividades creado exitosamente.",
            };
        }
    }
}
