...
namespace Application.UseCases.Categories
{
    public class CreateCategories(
        ...
        IValidator<CategoriesCreateDto> validator,
        IMapper mapper,
        ...
        )
    {
        ...
        private readonly IValidator<CategoriesCreateDto> _validator = validator;
        private readonly IMapper _mapper = mapper;
        private readonly ISqlConnectionFactory _sqlConnectionFactory = sqlConnectionFactory;
        private readonly IAuditService _auditService = auditService;
        private readonly IAuditLogFactory _auditLogFactory = auditLogFactory;

        public async Task<BaseResponseId> ExecuteAsync(CategoriesCreateDto dto, long userId, long businessId)
        {
            ...
            try
            {
                ...
                entity.CategoriesId = (long)created.Id;
