...
namespace Application.Validators.LeadsStatus
{
    public class LeadsStatusStatusToggleValidator : AbstractValidator<LeadsStatusStatusToggleDto>
    {
        public LeadsStatusStatusToggleValidator() {
            RuleFor(x => x.LeadsStatusId)
