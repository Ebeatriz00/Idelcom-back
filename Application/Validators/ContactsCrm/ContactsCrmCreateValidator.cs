...
{
    public class ContactsCrmCreateValidator : AbstractValidator<ContactsCrmCreateDto>
    {
        public ContactsCrmCreateValidator()
        {
            ...
            RuleFor(x => x.Email)
                ...
                .MaximumLength(550).WithMessage("El email no debe exceder los 50 caracteres.")
                .WithErrorCode(ErrorCodes.ValidationLength)
            ...
            RuleFor(x => x.Phone)
                .MaximumLength(50).WithMessage("El teléfono no debe exceder los 15 caracteres.")
                .WithErrorCode(ErrorCodes.ValidationLength)
