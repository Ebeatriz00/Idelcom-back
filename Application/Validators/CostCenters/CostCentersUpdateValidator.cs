...
{
    public class CostCentersUpdateValidator : AbstractValidator<CostCentersUpdateDto>
    {
        public CostCentersUpdateValidator()
        {
            ...
            RuleFor(x => x.Description)
                ...
                .MaximumLength(50) // Ajustado al varchar(50) de la tabla
