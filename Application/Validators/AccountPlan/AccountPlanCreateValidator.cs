...
{
    public class AccountPlanCreateValidator : AbstractValidator<AccountPlanCreateDto>
    {
        public AccountPlanCreateValidator() {
            ...
            RuleFor(x => x.AccountName)
                ...
                .Matches(@"^[a-zA-Z0-9\s\-,.áéíóúÁÉÍÓÚñÑ()]+$")
                .WithMessage("El descripción  tiene caracteres especiales.")
                .WithErrorCode(ErrorCodes.ValidationCharacterInvalid)
