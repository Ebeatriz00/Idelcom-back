...
{
    public class ProfilesPermissionsStatusToggleValidator : AbstractValidator<ProfilesPermissionsStatusToggleDto>
    {
        public ProfilesPermissionsStatusToggleValidator() {
            RuleFor(x => x.ProfilesPermissionsId)
