...
{
    public class ConceptTypeCreateValidator : AbstractValidator<ConceptTypeCreateDto>
    {
        public ConceptTypeCreateValidator()
        {
            ...
            RuleFor(x => x.Description)
                ...
                .NotEmpty()
                .WithMessage("La descripción del tipo de concepto es obligatoria.")
