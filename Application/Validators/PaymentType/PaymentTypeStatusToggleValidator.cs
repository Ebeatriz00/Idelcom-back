...
namespace Application.Validators.PaymentType
{
    public class PaymentTypeStatusToggleValidator : AbstractValidator<PaymentTypeStatusToggleDto>
    {
        public PaymentTypeStatusToggleValidator() {
