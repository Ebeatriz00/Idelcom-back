...
namespace Application.Validators.LeadsSources
{
    public class LeadsSourcesStatusToggleValidator : AbstractValidator<LeadsSourcesStatusToggleDto>
    {
        public LeadsSourcesStatusToggleValidator()
        {
