...
namespace Application.Validators.OpporViability
{
    public class OpporViabilityStatusToggleValidato : AbstractValidator<OpporViabilityStatusToggleDto>
    {
            public OpporViabilityStatusToggleValidato()
            {
