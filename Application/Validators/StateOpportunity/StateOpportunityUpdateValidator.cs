...
namespace Application.Validators.StateOpportunity
{
    public class StateOpportunityUpdateValidator : AbstractValidator<StateOpportunityUpdateDto>
    {
        public StateOpportunityUpdateValidator() {
            RuleFor(x => x.StateOpportunityId)
            ...
            RuleFor(x => x.StateColor)
                 ...
                 .MaximumLength(10)
                 .WithMessage("El color no debe exceder de los 10 caracteres.")
