...
{
    public class SsomaHomologationPersonnelCreateValidator : AbstractValidator<SsomaHomologationPersonnelCreateDto>
    {
        public SsomaHomologationPersonnelCreateValidator()
        {
