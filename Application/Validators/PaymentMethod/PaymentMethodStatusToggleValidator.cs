...
{
    public class PaymentMethodStatusToggleValidator : AbstractValidator<PaymentMethodStatusToggleDto>
    {
        public PaymentMethodStatusToggleValidator()
        {
            RuleFor(x => x.PaymentMethodId)
                .GreaterThan(0).WithMessage("ID de método de pago inválido.")
