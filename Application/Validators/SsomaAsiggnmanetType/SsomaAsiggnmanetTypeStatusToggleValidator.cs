...
{
    public class SsomaAsiggnmanetTypeStatusToggleValidator : AbstractValidator<SsomaAssignmanetTypeStatusToggleDto>
    {
        public SsomaAsiggnmanetTypeStatusToggleValidator()
        {
