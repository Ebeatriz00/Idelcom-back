...
{
    public class TaxAffTypeStatusToggleValidator : AbstractValidator<TaxAffTypeStatusToggleDto>
    {
        public TaxAffTypeStatusToggleValidator() {

            RuleFor(x => x.TaxAffTypeId)
