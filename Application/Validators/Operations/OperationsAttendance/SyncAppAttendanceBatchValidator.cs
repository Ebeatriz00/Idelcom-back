...
{
    public class SyncAppAttendanceBatchValidator : AbstractValidator<AppAttendanceSyncDto>
    {
        public SyncAppAttendanceBatchValidator()
        {
            ...
            RuleForEach(x => x.Details).SetValidator(new SyncAppAttendanceDetailValidator());
        }
    ...
    public class SyncAppAttendanceDetailValidator : AbstractValidator<AppAttendanceBatchDetailSyncDto>
    {
        public SyncAppAttendanceDetailValidator()
        {
