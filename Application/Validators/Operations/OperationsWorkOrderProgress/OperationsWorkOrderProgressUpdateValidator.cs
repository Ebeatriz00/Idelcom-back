...
{
    public class OperationsWorkOrderProgressUpdateValidator : AbstractValidator<OperationsWorkOrderProgressUpdateDto>
    {
        public OperationsWorkOrderProgressUpdateValidator()
        {
