...
namespace Application.Validators.LeadsQualifications
{
    public class LeadsQualificationsStatusToggleValidator : AbstractValidator<LeadsQualificationsStatusToggleDto>
    {
        public LeadsQualificationsStatusToggleValidator()
        {
            RuleFor(x => x.LeadsQualificationsId)
