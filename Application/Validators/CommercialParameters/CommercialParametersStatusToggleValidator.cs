...
{
    public class CommercialParametersStatusToggleValidator : AbstractValidator<CommercialParametersStatusToggleDto>
    {
       public CommercialParametersStatusToggleValidator() {

            RuleFor(x => x.CommercialParametersId)
