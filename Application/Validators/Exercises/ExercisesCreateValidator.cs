...
{
    public class ExercisesCreateValidator : AbstractValidator<ExercisesCreateDto>
    {
        public ExercisesCreateValidator()
        {
            ...
            RuleFor(x => x.Description)
                ...
                .NotEmpty()
                .WithMessage("La descripción del ejercicio es obligatoria.")
