namespace Core.Projections.Logistic
{
    ...
    public class PurchaseOrderHeaderProjection
    {
        public long PurchaseOrderId { get; set; }
    ...
    public class PurchaseOrderDetailProjection
    {
    ...
    public class PurchaseOrderByIdProjection
    {
        public PurchaseOrderHeaderProjection? Header { get; set; }
        public IReadOnlyList<PurchaseOrderDetailProjection> Details { get; set; } = Array.Empty<PurchaseOrderDetailProjection>();
        public IReadOnlyList<PurchaseOrderInvoiceProjection> Invoices { get; set; } = Array.Empty<PurchaseOrderInvoiceProjection>();
    }

    public class PurchaseOrderInvoiceProjection
    {
