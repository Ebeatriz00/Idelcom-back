...
{
    public class PurchaseReceiptListItem
    {
    ...
    public class PurchaseReceiptHeaderProjection : PurchaseReceiptListItem
    {
    }

    public class PurchaseReceiptDetailProjection
    {
    ...
    public class PurchaseReceiptByIdProjection
    {
        public PurchaseReceiptHeaderProjection? Header { get; set; }
        public IReadOnlyList<PurchaseReceiptDetailProjection> Details { get; set; } = Array.Empty<PurchaseReceiptDetailProjection>();
    }
}
